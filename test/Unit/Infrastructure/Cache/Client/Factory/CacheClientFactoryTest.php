...
namespace SelecaoGlobo\Unit\Infrastructure\Cache\Client\Factory;
 ...
 */
class CacheClientFactoryTest extends AbstractUnitTestCase
{
    /**
     * @return void
     */
    ...
    public function testInvoke(): void
    {
        ...
        $exception = null;
        try {
            (new CacheClientFactory())($this->container);
        } catch (Exception $e) {
            $exception = $e;
        }
