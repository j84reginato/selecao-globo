...
use SelecaoGlobo\BFF\Desktop\Application\Dependency\Domain\Service\Hydrator;
use SelecaoGlobo\Unit\AbstractUnitTestCase;

/**
 * Class HydratorTest
 */
class HydratorTest extends AbstractUnitTestCase
{
    /**
     * @return void
     */
    public function testGetDependencies(): void
    {
        ...
        $dependencies = Hydrator::getDependencies();
